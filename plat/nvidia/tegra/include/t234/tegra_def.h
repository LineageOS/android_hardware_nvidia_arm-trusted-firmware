...
/*******************************************************************************
 * Tegra PMC MISC constants
 ******************************************************************************/
#define TEGRA_PMC_MISC_BASE			U(0xC3A0000)
#define TEGRA_PMC_MISC_DEBUG_AUTHENTICATION_0	U(0x14)
#define TEGRA_PMC_MISC_DBG_AUTH_SPIDEN_BIT	BIT(3)
#define TEGRA_PMC_MISC_DBG_AUTH_DBGEN_BIT	BIT(5)
