...
# Flag to apply erratum 2821985 during core power ON
ERRATA_A78_AE_2821985                   := 1
$(eval $(call add_define,ERRATA_A78_AE_2821985))

# Enable workarounds for selected Cortex-A78 AE errata.
CORTEX_A78_AE_H_INC			:=	1
$(eval $(call add_define, CORTEX_A78_AE_H_INC))

# Flag to apply erratum 3604886 workaround during reset.
ERRATA_A78_AE_3604886			:= 1
...
override ENABLE_FEAT_RAS		:= 1
override HANDLE_EA_EL3_FIRST_NS		:= 1
