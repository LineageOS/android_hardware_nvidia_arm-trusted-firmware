...
DEFINE_RENAME_SYSREG_RW_FUNCS(cnthv_ctl_el2, CNTHV_CTL_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(cnthv_cval_el2, CNTHV_CVAL_EL2)

DEFINE_RENAME_SYSREG_RW_FUNCS(cnthps_ctl_el2, CNTHPS_CTL_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(cnthps_cval_el2, CNTHPS_CVAL_EL2)

DEFINE_RENAME_SYSREG_RW_FUNCS(cnthvs_ctl_el2, CNTHVS_CTL_EL2)
DEFINE_RENAME_SYSREG_RW_FUNCS(cnthvs_cval_el2, CNTHVS_CVAL_EL2)

DEFINE_RENAME_SYSREG_RW_FUNCS(cntkctl_el1, CNTKCTL_EL1)

DEFINE_RENAME_SYSREG_READ_FUNC(cntvct_el0, CNTVCT_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(cntv_ctl_el0, CNTV_CTL_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(cntv_cval_el0, CNTV_CVAL_EL0)
...
DEFINE_RENAME_SYSREG_READ_FUNC(erxmisc2_el1, ERXMISC2_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(erxmisc3_el1, ERXMISC3_EL1)
DEFINE_RENAME_SYSREG_READ_FUNC(erxpfgf_el1, ERXPFGF_EL1)
DEFINE_RENAME_SYSREG_WRITE_FUNC(erxpfgcdn_el1, ERXPFGCDN_EL1)
